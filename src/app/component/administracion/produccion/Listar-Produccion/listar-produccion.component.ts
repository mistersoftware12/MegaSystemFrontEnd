...
@Component({
  selector: 'app-listar-produccion.component',
  templateUrl: './listar-produccion.component.html',
  styleUrls: ['./listar-produccion.component.css'],
})

export class ListarProduccionComponent implements OnInit {

  loaderActualizar: boolean;

  public UsuarioLista: Usuario[] = [];

  displayedColumns: string[] = ['id', 'cedula', 'nombre', 'telefono',  'documento'];
  ...
  public listarInformacion() {
    ...
    this.produccionService.getAlProdducto(idEmpresa.getIdEmpresa).subscribe(value => {
