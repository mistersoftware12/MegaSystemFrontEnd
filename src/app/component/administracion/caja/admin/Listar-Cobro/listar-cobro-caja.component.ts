...
@Component({
  selector: 'app-listar-cobro-caja.component',
  templateUrl: './listar-cobro-caja.component.html',
  styleUrls: ['./listar-cobro-caja.component.css'],
})

export class ListarCobroCajaComponent implements OnInit {
  ...
  public cerrarCaja(id: any) {
    ...
    Swal.fire({
      title: 'Deseas registrar este cobro?',
      text: "",
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        ...
        var data: CajaRequest = new CajaRequest();
        data.id = id;
        data.fechaActual = fechaActual.getFechaActual;
        this.cajaService.createCobroCaja(data).subscribe(value => {
  ...
  public listarInformacion() {
    ...
    this.cajaService.getCajaNoCobrado(idEmpresa.getIdEmpresa).subscribe(value => {
  ...
  exportToExcel(): void {
    ...
    XLSX.writeFile(book, 'Lista de Cobros Pendientes.xlsx');
  }
