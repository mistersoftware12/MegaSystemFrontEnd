...
export class ListarCategoriaComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'nombre',  'documento'];
  ...
  public mostrarNuevo() {
    this.router.navigate(['/panel/biblioteca/creaModificarCategoria']);
  }
  ...
  public listarInformacion() {
    ...
    this.categoriaService.getAlCategoria(idEmpresa.getIdEmpresa).subscribe(value => {
